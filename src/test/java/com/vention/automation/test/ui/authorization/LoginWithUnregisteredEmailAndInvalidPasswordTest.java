...
public class LoginWithUnregisteredEmailAndInvalidPasswordTest extends CommonConditions {
    ...
    public void loginWithUnregisteredEmailAndInvalidPassword() {
        User user = new User(UserBuilder.getUnregisteredEmail(), UserBuilder.getInvalidPassword());
        loginPage.openPage();
